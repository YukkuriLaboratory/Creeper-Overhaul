...
public class ReplacedCreeperGlowLayer<R extends CreeperRenderState & GeoRenderState> extends GeoRenderLayer<ReplacedCreeper, net.minecraft.world.entity.monster.Creeper, R> {
