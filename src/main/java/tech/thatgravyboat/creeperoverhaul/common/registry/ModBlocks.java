...
public class ModBlocks {
    ...
    public static final RegistryEntry<Block> POTTED_TINY_CACTUS = BLOCKS.register("potted_tiny_cactus", () -> new FlowerPotBlock(TINY_CACTUS.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.POTTED_CACTUS)));
}
