...
public class ModSpawns {
    ...
    public static boolean checkMonsterSpawnRulesCave(EntityType<? extends Monster> pType, ServerLevelAccessor pLevel, SpawnReason pReason, BlockPos pPos, RandomSource pRandom) {
    ...
    public static boolean checkMonsterSpawnRulesAbove(EntityType<? extends Monster> pType, ServerLevelAccessor pLevel, SpawnReason pReason, BlockPos pPos, RandomSource pRandom) {
    ...
    public static boolean checkWaterSpawnRules(EntityType<? extends Monster> pType, ServerLevelAccessor pLevel, SpawnReason pReason, BlockPos pPos, RandomSource pRandom) {
    ...
    public static boolean checkDayMonsterSpawnRulesAbove(EntityType<? extends Monster> pType, ServerLevelAccessor pLevel, SpawnReason pReason, BlockPos pPos, RandomSource pRandom) {
